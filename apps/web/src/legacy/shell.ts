        ...
        <div class="sh">
          ...
          <div class="source-switch">
            ...
            <div class="source-toggle" role="group" aria-label="Data source">
              <button class="source-btn" type="button" id="source-poc" data-source-id="poc">POC</button>
              <button class="source-btn" type="button" id="source-production" data-source-id="production">Production</button>
            </div>
          </div>
          <div class="source-meta" id="source-meta">Loading dataset…</div>
        </div>
